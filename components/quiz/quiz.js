...
import { getQuestionsFromId, sendExamResult } from '@/service';
...
function Quiz() {
    ...
    return (
        ...
        <section class="">
            ...
            {isQuizFinish == false ? (<div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">

                <div class="w-full bg-white rounded-lg shadow dark:border sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    <div style={{ width: "100%" }} class=" py-5 rounded text-center overflow-hidden shadow-lg">
                ...
                <div class="w-full m-10 bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    }} style={{ width: "100%" }} class="text-bold cursor-pointer  py-5 rounded text-center overflow-hidden shadow-lg">
                ...
                <div class="w-full m-10 bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    <div onClick={(e) => {
                        ...
                        <h1 class="text-4xl">Exam is Over</h1>

                    </div>
                    <div onClick={(e) => {
                        
                          sendExamResult(currentQuiz, answers)
                          set("")
                    }} style={{ width: "100%" }} class="text-bold cursor-pointer  py-5 rounded text-center overflow-hidden shadow-lg">
